...
export class HtmlTufteGenerator implements Generator {
    private extMan: ExtensionsManager;
    private renderer: HtmlTufteRenderer;
    ...
    constructor(
        ...
        this.renderer = new HtmlTufteRenderer({
    ...
    public generate(ast: XmdAst): Promise<string> {
        ...
        if (!HtmlTufteGenerator.checkAst(ast)) {
